...
?>
        <section class="h-100">
            <div class="container h-100">
                ...
                <style>
                  ...
                  .toggle-password svg.eye-closed {
                    display: none;
                  }
                ...
                <div class="mb-3 password-wrapper">
                  ...
                  <button type="button" class="toggle-password" onclick="togglePasswordVisibility(this)">
                    ...
                    <!-- Eye closed -->
                    <svg class="eye-closed" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path d="M12 6c3.88 0 7.23 2.44 8.5 6-0.61 1.67-1.8 3.11-3.31 4.1l1.42 1.42C20.41 15.85 22 14.04 23 12c-1.73-3.89-6-7-11-7
                      -1.45 0-2.83.25-4.1.7l1.46 1.46C10.26 6.09 11.12 6 12 6zm0 12c-3.88 0-7.23-2.44-8.5-6 0.61-1.67 1.8-3.11 3.31-4.1l-1.42-1.42C3.59 8.15 2 9.96 1 12c1.73 3.89 6 7 11 7
                      1.45 0 2.83-.25 4.1-.7l-1.46-1.46C13.74 17.91 12.88 18 12 18zm0-10a5 5 0 015 5c0 .88-.24 1.74-.7 2.46l-6.76-6.76C10.26 8.24 11.12 8 12 8zm-7.73-3.73L20.73 20.73l-1.41 1.41L2.86 5.68 4.27 4.27z"/>
                    </svg>
                  </button>
                </div>
            ...
            <script>
              function togglePasswordVisibility(button) {
                const input = document.getElementById('fm_pwd');
        ...
        <div class="mb-3">
                    <style>
                      /* Estilos del botón animado de Uiverse */
                      .animated-button {
                        position: relative;
                        display: flex;
                        align-items: center;
                        ...
                        font-size: 16px;
                        background-color: white; /* Asegúrate de definir un color */
                        border-radius: 100px;
                        font-weight: 600;
                        color: #1f387e;
                    ...
                    <!-- Botón animado de Uiverse -->
                    <button type="submit" class="animated-button w-100 mt-4" role="button">
                      <svg xmlns="http://www.w3.org/2000/svg" class="arr-2" viewBox="0 0 24 24">
                        <path d="M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z"></path>
                      </svg>
                      <span class="text"><?php echo lng('Login'); ?></span>
